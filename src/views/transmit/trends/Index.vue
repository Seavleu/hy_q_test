...
const { 
  ...
  zoomIn, 
  zoomOut 
} = useFetchStats(TRANSMISSION_API.trends, chartJson)
fetchChartStats()
</script>
...
<template>
  <div class="transmit-power-con">
    ...
    <div class="box-com" v-else>
    <div class="transmit-power-con">
      <div class="trends-con">
        <div class="sub-title">
          <dl>
            <dt>SMP/REC 동향 통계차트</dt>
            <dd>
              전력거래소에서 제공하는 <span>2023년 9월 4일(어제)</span> 까지의 SMP/REC 가격변동 동향을 확인할 수 있습니다.
            </dd>
          </dl>
        </div>
        ...
        <div class="trends-box">
          <ul>
            ...
            <li>
              <dl>
                <dt>SMP 변동률</dt>
                <dd class="up"><strong>876</strong> REC</dd>
              </dl>
            </li>
            <li>
              <dl>
                <dt>이전 REC 거래소 종가</dt>
                <dd><strong>876</strong> 원</dd>
              </dl>
            </li>
            <li>
              <dl>
                <dt>최근 REC 거래소 종가</dt>
                <dd><strong>876</strong> 만원</dd>
              </dl>
            </li>
            <li>
              <dl>
                <dt>REC 변동률</dt>
                <dd class="down"><strong>876</strong> 만원</dd>
              </dl>
            </li>
          </ul>
        </div>
